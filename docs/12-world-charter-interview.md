# 12 — The World Charter Interview

The mechanics of _Earth Kings_ are specified to the decimal. The **world** is not. Gates, the
Tower, the Codex, the Heart Empire and the 900-step fade all exist as rules; almost none of them
exist as *facts about a place*. This document is the interview that fixes that.

It is written to be answered **alone, by two people, separately**, and then reconciled. Do not
read the other person's sheet before you finish yours. The disagreements are the valuable part —
they are where the world is actually undecided, and everything you both assumed silently will
show up as an agreement you never had to argue for.

- **How to run it:** [worldbuilding/00-process.md](worldbuilding/00-process.md)
- **Answer here:** [worldbuilding/answers-a.md](worldbuilding/answers-a.md) ·
  [worldbuilding/answers-b.md](worldbuilding/answers-b.md)
- **Disagreements land here:** [worldbuilding/divergence-ledger.md](worldbuilding/divergence-ledger.md)

## How to answer

- One to three sentences. If it takes a paragraph, you are designing, not answering — put the
  paragraph in the ledger later.
- Tag every answer with how much you care, not how sure you are:
  `[H]` I have a real stake · `[M]` a preference · `[L]` a shrug · `[—]` I genuinely do not care,
  the other person decides · `[!]` **veto** — I would stop working on this if it went the other
  way. You get **three vetoes for the whole interview.** Spend them like they cost money.
- `?` is a legal answer and a useful one. It means "nobody has thought about this", which is
  different from "this is open on purpose".
- Where a question says **(repo:)** the codebase already implies an answer. You may confirm it,
  or overturn it — overturning is allowed and is the point of asking. Note the cost.
...
| FR3 | Is the world tragic, indifferent, or secretly just? Does effort get rewarded by the universe, by people, or by nothing? |
| FR4 | **What does "Earth Kings" mean?** Who is a king, what is the Earth in that phrase, and is the title claimed, inherited, or given? Is the player one, hunting one, or neither? |
| FR5 | Is this our Earth — after something, before something — or a different world entirely? |
| FR6 | The Codex permits "absurd results" as valid output. Is absurdity a truth about the world's underlying physics, or a joke shared with the player over the world's head? |
| FR7 | A player just lost a character they cared about. What should they feel in the ten seconds after — grief, injustice, guilt, or the flat click of a rule? |
| FR8 | Should the world end up explicable? Name one thing that must still be unexplained when the Codex reads 100%. |
...
| SK6 | **What is a step?** Roughly how far, and how long does it take? Everything in the game is priced in steps — 900 to forget a book, 600 before a gate breaks — so this number silently sets every other pace. (repo: 120 steps per season, so a year ≈ 480 steps.) |
...
| LN2 | What is beyond the map edge — ocean, more land, nothing you can reach? (repo: `ferry.gd` runs coastal cutters between ports, so there is a coast and there are boats.) |
...
| ID | Question |
| --- | --- |
| CL1 | The seasons are named for clovers — Lesser Green, Green, Brown, Ice. Why a clover? Who named them, and does the name predate the game's world or belong to one people? |
| CL2 | Does the season turn everywhere at once, or does it sweep? (repo: it flips globally at a step count.) |
| CL3 | Is winter deadly to ordinary people — a thing survived — or merely cold? |
...
| LF2 | The Bamboo Court has red panda masters, sword bears, cannon bears. **Are those people or beasts?** Do they talk, hold property, bury their dead? |
| LF3 | Are gate-monsters alive — do they eat, sleep, breed, age, bleed? |
| LF4 | Where do gate-monsters *come from*: born behind the gate, made by it, or pulled through from a world where they were ordinary? |
...
| LF9 | Are there plants, fungi or animals that only exist near a gate? What does long exposure do to farmland? (repo: a broken gate raises local danger 25pp — does it also poison the ground?) |
...
| MK3 | Is there printing, or is every book copied by hand? This decides what a library *is*. |
...
| MK11 | The **bed** at home grants permanent HP, up to +22 for a canopied one. What is that, physically? Is comfort literally strengthening, or is it rest, safety, something being kept away? |
| MK12 | Are charms manufactured or found? (repo: D24 — found on gate delves, carried by delvers who died there. So who made the one they were carrying?) |
...
| ID | Question |
| --- | --- |
| GT1 | **What is a gate?** A hole to another place, a wound in this one, a door that was built, or a mouth? |
| GT2 | What is on the other side — a whole world, a pocket, a stomach, nothing that would survive being described? |
| GT3 | Who or what opens them? Is it an event, an intention, or a natural process like weather? |
...
| GT6 | When a gate **breaks** (D15), what actually happens on the ground — does it burst, spread, sink, or simply start walking? |
| GT7 | When a gate is **shut forever**, what is left behind? A scar, a monument, a good field, nothing? |
| GT8 | Gates never reopen, yet new rifts tear open under continental pressure (D26). **Is there a fixed number?** Is the world running out, or being slowly emptied into? |
...
| GT12 | The Spire Archon at the top (D25). Is it a ruler, a jailer, a gardener, a machine, or the last thing that was ever put there? |
| GT13 | Does the Tower have doors on other floors — could a person live in it? Does anyone? |
| GT14 | What is the **deep**? D26 names subterranean seals under continental strain. Is there an underworld, and is it geological or occupied? |
...
| BD2 | Permadeath is the rule, but a **grace** buys survival — charm, ally, book, ground, luck. Is a grace a physical event, a moral one, or a law of the world? Did someone write these rules down, or are they the odds of being lucky? |
...
| BD5 | Is there an afterlife? Do people believe there is, and are they right? |
| BD6 | Can the dead be raised, ever, by anyone, at any price? (This is a one-way-door question — answer it once and never again.) |
| BD7 | Do the dead remain as anything — ghosts, revenants, gate-things wearing a face? |
| BD8 | What do people do with bodies: burial, burning, exposure, the sea? (repo: `memorials.json` exists — memorials *for* whom, placed by whom?) |
...
| ID | Question |
| --- | --- |
| MN1 | Is there a soul, a spirit, a self that is more than the body? Who says so? |
| MN2 | Do animals think? Do monsters? Is the difference one of kind or of degree? |
...
| ID | Question |
| --- | --- |
| KN1 | **Doctrine fades in 900 steps if unused.** Is that forgetting, or is the knowledge itself leaving? Does the book still say the same words tomorrow? |
| KN2 | Nothing is inherited — a taught student holds it, a child does not. **Why can't it be inherited?** Is that a fact about minds or a rule someone enforces? |
| KN3 | What is a book made of, who copies it, and what does one cost? |
| KN4 | Can a character **write** a book? Could the party leave something behind that another character could read? |
...
| KN9 | Can doctrine be wrong? Is there a false book that teaches a thing that does not work, or works badly? |
...
| ID | Question |
| --- | --- |
| PW1 | **What is the grammar?** Skill trees are generated from a hidden system of themes and archetypes. Is that a law of nature, a language, an artefact, or a mind? |
| PW2 | Did anyone write it? Is there an author, and is the author still around? |
| PW3 | Is the grammar the same thing that makes gates, or a separate fact about the world? |
...
| PW5 | Can ordinary people use power, or is it delvers only? Does the village smith have a rung of a tree? |
...
| PW8 | The **Codex** is the world's catalogue of the grammar. Who else is cataloguing? Is the player the only one working on this, or joining a long effort? |
...
| ID | Question |
| --- | --- |
| NW1 | News travels roughly a tile per 14 steps. **What carries it?** Riders, traders, birds, gossip, something stranger? |
| NW2 | Does news degrade as it travels — becoming rumour, exaggeration, a different story with your name still in it? |
...
| NW5 | Is there any written record kept centrally, or is everything local memory? |
...
| ID | Question |
| --- | --- |
| BL1 | What does an ordinary villager believe a gate is? Is that belief correct? |
...
| BL6 | Do people believe the world is getting worse, better, or going around in a circle? |
...
| ID | Question |
| --- | --- |
| SF1 | Does the player character know they are unusual? (repo: D14 — the run continues when companions die and ends when you do. Is that a fact about the world or about the game?) |
...
| SF4 | Do characters know about levels, classes, doctrine, ranks — is the game's vocabulary the world's vocabulary? |
...
| SF7 | Is there prophecy or fate? (repo: `fate.json` exists.) If so, is it accurate, and does knowing it change it? |
...
| RU2 | **The Heart Empire "came up the road one spring and never named a reason." What is the reason?** Do they know it themselves? |
| RU3 | Is the Heart Empire a state, a religion, an army, or an infection? What happens to a village it takes? |
| RU4 | Rank is read off the metal — copper at the gate, white at the throne. **Is there a throne, and is anyone on it?** |
| RU5 | What are the **Freeholds** — a federation, a habit, a word for everyone unaligned? Who speaks for them? |
...
| RU9 | What is the largest thing that can be called a government here? Does any authority reach further than a day's ride? |
...
| RU13 | **What happened to kings?** The game is called _Earth Kings_ and the factions are legions, courts, tides and wilds. Is kingship dead, ongoing, or the thing being competed for? |
...
| LW5 | Captives are ransomed at a price, on a deadline, and may be **sold** if the deadline lapses. **Sold to whom, for what work?** Is slavery legal, normal, or hidden? |
| LW6 | Is there a law of hospitality — a rule about the road, the hearth, the guest? What does breaking it cost? |
| LW7 | Do oaths bind legally, religiously, or only personally? (Several heroes are defined by sworn oaths and ancestral grudges.) |
| LW8 | A **grudge** grants +10% damage against an ancestral foe. Is vengeance a recognised right here? Is there a feud culture, and does anyone try to end feuds? |
...
| EC3 | What does an ordinary person earn in a year, expressed in the game's gold? This sets whether a 120-gold ransom is a fortune or a bar tab. |
| EC4 | Who produces food, and who eats without producing it? |
| EC5 | Is there trade over distance? What moves — salt, iron, books, people? (repo: coastal ferries, trade routes that pay out on upkeep ticks.) |
...
| EC9 | Delvers come home with gate-gold. Does that wreck local prices? Is a delver rich, or just liquid? |
...
| ID | Question |
| --- | --- |
| KI1 | What is a household — nuclear, extended, communal, chosen? |
| KI2 | Who raises children, and to what age are they children? |
...
| KI6 | Every one of the twelve heroes is an orphan, an exile, a stray or a cloistered scholar who left. **Is the rootless adventurer the norm, or is the game's cast a survivorship bias?** |
...
| KI11 | **Home** is inviolable — nothing camps within sight of it, sleeping there always heals. Is that true of every home in the world, or only the player's? If every home, *why*? |
...
| FA2 | Toln is a **hedge priest** who records "ancient chants" and left a monastery. **A priest of what?** |
...
| FA8 | The **Training Yoke** is self-imposed handicap for growth. Is that an ascetic tradition with a name and a lineage, or a private trick? |
| FA9 | Is there a heresy — a belief that gets you killed or driven out? |
| FA10 | Does religion say anything about gates? If the world's faiths predate the gates, how did they adapt? |
...
| TG5 | How do people date events with no eras and no central calendar — by season, by ruler, by disaster? |
...
| DY2 | What do people drink, and where? (repo: there are alehouses, taphouses, serais and longhouses; you hire whoever is drinking there.) |
| DY3 | What does an inn owe a traveller, and what does it charge? |
| DY4 | What do people wear — materials, colours, what marks status? |
| DY5 | How do people fight for fun? (repo: the **Coliseum** — cards, waves, bouts, wagers, free-for-alls. Whose institution is that?) |
...
| AR8 | What is a **ruin** in this world — old war, old gate, old people, or something that was never finished? |

### III.i Outsiders and the monstrous — `OT`

| ID | Question |
| --- | --- |
| OT1 | Is there any peace between people and gate-things, anywhere, ever? |
...
| OT4 | Are the Bamboo Court's beasts considered people by anyone but themselves? |
| OT5 | What happens to someone who comes back from a gate changed? |
| OT6 | Can something from a gate pass as a person? |
...
| DV3 | Who pays for a gate to be shut? Does anyone, or is the gold simply inside? |
...
| ID | Question |
| --- | --- |
| HS1 | What is the single biggest thing that has happened in this world's past, and how long ago? |
...
| HS8 | Is the world's story going somewhere? If the player never existed, what would the next fifty years be? |
...
| ID | Question |
| --- | --- |
| SM1 | **Save-scumming is allowed** (D21) and permadeath is a pillar. Is reloading a fact about the world, a fact about the player, or a hole we agree never to look at? |
| SM2 | Difficulty settings change enemy strength, grace odds and **whether permadeath exists at all**. Are these different worlds, or the same world at different volumes? Should Gentle be told to the player as mercy or as a different fiction? |
...
| SM5 | The run ends when the player character dies but the world is saved. Is the next run the **same world** later, a different one, or a reset? This is the biggest open question in the project. |
...
| SM8 | Companions are hired for gold and dismissed at will, and D14 says the story continues when they die. **How do we make a hire matter** — is it fiction's job, mechanics' job, or accepted as a cost of the design? |
...
| SM11 | LLM minds are deferred (D03). If they land, what is the **one thing** an NPC must never say or do without asking us first? |
...
| ID | Question |
| --- | --- |
| BN1 | Name one thing that must **never** be true of this world. |
...
| BN5 | Which of the six design pillars in [01 — Vision](01-vision.md) would you defend last? Which would you drop first? |
...
Nothing here is canon until it is reconciled and written down. The route out of this document is:

1. Both sheets filled, alone → [divergence ledger](worldbuilding/divergence-ledger.md).
2. Agreed answers → a new `docs/13-world-bible.md`, one line each, plain statements of fact.
3. Anything that changes a **rule** → a numbered entry in [06 — Decisions](06-decisions.md),
   because that file is append-only and is where future-you will look.
4. Anything that becomes **content** → a JSON task against `data/`, per working rule 1.
5. Anything neither of you cares about stays **open**, and is not invented to fill a gap.
