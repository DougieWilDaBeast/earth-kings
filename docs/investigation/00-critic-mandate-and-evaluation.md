...
| ------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **00**  | [docs/investigation/00-critic-mandate-and-evaluation.md](00-critic-mandate-and-evaluation.md)                                   | **The Mandate:** Core critique, thesis, diagnostic capabilities, and investigation charter.                                                   |
| **01**  | [docs/investigation/01-tactical-grid-and-combat-systems.md](01-tactical-grid-and-combat-systems.md)                             | **Tactics & Combat:** The unified party phase, action economy, directional flanking, AI lethality, and consumable pacing.                     |
| **02**  | [docs/investigation/02-world-topology-and-the-step-clock.md](02-world-topology-and-the-step-clock.md)                           | **Topology & Step Chronometry:** The 128×128 continental map, the step-clock upkeep engine, prowler sight cones, and roadside economics.      |
| **03**  | [docs/investigation/03-character-progression-and-the-mortality-engine.md](03-character-progression-and-the-mortality-engine.md) | **Progression & Mortality:** Permadeath graces, the Training Yoke, procedural skill tree agency, and doctrine entropy.                        |
